...
const faqs = [
  ...
  },
  {
    ...
    a: 'Программа проходит три дня: вечер пятницы, суббота (весь день) и воскресенье (весь день). Такой формат погружения позволяет пройти путь без отрыва на всю неделю.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да. В зависимости от программы — разборы в мини-группах, чат участников и личный наставник на продвинутой программе.',
  },
];
