        ...
        <div className="b-container">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg" style={{ color: 'var(--b-ink-soft)' }}>
              Это трёхдневный очный старт с тренером Еленой Ширыкаловой: 2 октября (вечер),
              3 и 4 октября 2026 года — весь день. Формат построен так, чтобы за три дня пройти
          ...
          <div className="mt-8 b-card p-8 md:p-10 max-w-3xl" style={{ border: '1px solid var(--b-fire)' }}>
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium">
                2 октября (вечер) — знакомство и запуск. 3–4 октября (весь день) — практика и результат.
              </span>
            </div>
          </div>
