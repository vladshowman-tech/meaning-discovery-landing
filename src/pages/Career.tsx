...
const routeDays = [
  { day: '02', label: 'Вечер знакомства', desc: 'Погружение в программу, знакомство с группой и запуск личного вектора.' },
  { day: '03', label: 'День практики', desc: 'Разбор запросов, работа с лидерскими качествами и харизмой.' },
  { day: '04', label: 'День результата', desc: 'Закрепление навыков, план действий и конкретные шаги к цели.' },
];
