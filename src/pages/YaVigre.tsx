...
const HERO_IMG =
  'https://cdn.poehali.dev/projects/35e9750e-aa05-49ef-b129-884fed200ea0/files/6ee0e9dc-ecee-444c-958d-850b3cfaceb8.jpg';

const navLinks = [
  { l: 'О ступени', h: '#yv-about' },
  { l: 'Что внутри', h: '#yv-program' },
  { l: 'Тренер', h: '#mentor' },
  { l: 'Результат', h: '#yv-result' },
  { l: 'Вопросы', h: '#yv-faq' },
];
...
const faqs = [
  {
    q: 'Нужно ли сначала пройти «Точку Старта»?',
    a: 'Да, это обязательное условие. «Я в игре» — вторая ступень, она опирается на результаты первой и продолжает работу с уже заложенными ориентирами.',
  },
  {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 glass py-4">
        <div className="container flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button variant="ghost" onClick={() => navigate('/tochkastarta')} className="rounded-full text-sm">
              <Icon name="ArrowLeft" size={15} className="mr-1.5" /> К ступени №1
            </Button>
            <Button onClick={() => go('#yv-form')} className="rounded-full font-medium glow">
              Записаться
            </Button>
          </div>
      ...
      <main>
          ...
          <div className="container relative grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-sm animate-fade-up">
                ...
                <span className="text-primary font-medium">Ступень №2 · открывается после «Точки Старта»</span>
              </div>
              ...
              >
                <span className="text-gradient italic">«Я в игре»</span>
                <br />
                От слов — к масштабу
              </h1>
              ...
              >
                Масштабируем результаты «Точки Старта», преодолеваем страх перед амбициозными
                целями и переходим от слов к по-настоящему масштабным действиям.
              </p>
              ...
              >
                ...
                >
                  Записаться на ступень №2
                  <Icon name="ArrowRight" size={18} className="ml-1" />
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => go('#yv-program')}
            ...
            <div className="relative animate-fade-up" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="relative rounded-[2rem] overflow-hidden border border-border glow">
                <img
                  src={HERO_IMG}
                  alt="Я в игре — масштабные действия"
              ...
              <div className="absolute -left-6 bottom-10 glass rounded-2xl px-5 py-4 animate-float-slow max-w-[220px]">
                <div className="flex items-center gap-2 text-primary">
                  ...
                  <span className="font-display text-lg font-semibold">В игре по-крупному</span>
                </div>
        ...
        <section id="yv-about" className="relative py-24 md:py-32">
          <div className="container">
            ...
            <div id="yv-program" className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {focusPoints.map((b, i) => (
                <div
                  key={b.title}
        ...
        <section id="yv-result" className="relative py-24 md:py-32">
        ...
        <section id="yv-form" className="relative py-24 md:py-32">
          <div className="container">
            <div className="relative overflow-hidden rounded-[2.5rem] border border-border p-10 md:p-16 text-center">
              ...
              <div className="relative max-w-2xl mx-auto">
                <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-sm">
                  ...
                  Бесплатная консультация по ступени №2
                </div>

                <h2 className="mt-6 font-display text-4xl md:text-6xl font-semibold leading-[1.02]">
                  Готовы войти
                  <br />
                  <span className="text-gradient italic">в масштабную игру?</span>
                </h2>
                <p className="mt-5 text-lg text-muted-foreground">
        ...
        <section id="yv-faq" className="relative py-24 md:py-32">
          ...
          <div className="grid md:grid-cols-[1.5fr_1fr_1fr] gap-10">
            <div>
              ...
              <p className="mt-4 max-w-sm text-sm text-muted-foreground leading-relaxed">
                Ступень №2 «Я в игре» — масштабирование результатов «Точки Старта» и переход
                от слов к масштабным действиям.
              </p>
            </div>
